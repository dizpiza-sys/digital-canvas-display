...
const defaultWidgets: Widget[] = [
  {
    id: 'clock-1',
    type: 'clock' as const,
    position: { x: 40, y: 40, width: 200, height: 160 },
    showSeconds: true,
    showDate: true,
  },
  {
    ...
    position: { x: 280, y: 40, width: 200, height: 160 },
    city: 'تهران',
  },
  {
    id: 'prayer-1',
    type: 'prayer-times' as const,
    position: { x: 520, y: 40, width: 200, height: 160 },
  },
  {
    id: 'news-1',
    type: 'news' as const,
    position: { x: 40, y: 880, width: 800, height: 80 },
    items: [],
    speed: 50,
  },
];
